...
export function ConfigurationPage() {
  ...
  if (error && !rows) return <><PageHeader code="BUSINESS" title="业务配置" description="管理业务模块可读取的自定义环境变量。" /><ErrorState error={error} retry={load} /></>;
