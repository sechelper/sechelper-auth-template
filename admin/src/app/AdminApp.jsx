...
function Page({ pathname, session }) { if (pathname === "/admin") return <DashboardPage session={session} />; if (pathname === "/admin/orders") return <OrdersPage />; if (pathname === "/admin/manifest") return <ManifestPage />; if (pathname === "/admin/sessions") return <SessionsPage />; if (pathname === "/admin/permissions") return <PermissionsPage />; if (pathname === "/admin/audit-events") return <AuditPage />; if (pathname === "/admin/resources") return <ResourcesPage />; return <NotFoundPage />; }
