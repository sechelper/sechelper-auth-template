...
export function InstallPage() {
  ...
  const submit = async (event) => {
    ...
    try { await jsonRequest("/v1/install/configuration", { method: "PUT", headers: { "X-Install-Key": installKey }, body: JSON.stringify({ entries }) }); window.location.assign("/"); }
