...
export const menu = [
  ...
  { path: "/admin/orders", label: "订单", icon: "orders", permission: "order:read" },
  { path: "/admin/manifest", label: "权限 Manifest", icon: "manifest", section: "权限与资源", permission: "auth:manifest:read" },
  { path: "/admin/permissions", label: "权限清单", icon: "permissions", section: "权限与资源", permission: "auth:manifest:read" },
  { path: "/admin/resources", label: "资源目录", icon: "resources", section: "权限与资源", permission: "admin:access" },
...
const iconPaths = {
  ...
  orders: ["M3 5h2l2 11h10l2-8H6", "M9 20h.01", "M17 20h.01"],
