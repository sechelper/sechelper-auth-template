...
const allFrameworkVariables = [
  ["APP_ENV", "app.environment / APP_ENV", false, "development", "development"], ["APP_NAME", "应用名称", false, "", ""],
  ["SERVER_READ_TIMEOUT", "读取超时", false, "10s", "10s"], ["SERVER_WRITE_TIMEOUT", "写入超时", false, "15s", "15s"], ["SERVER_IDLE_TIMEOUT", "空闲超时", false, "60s", "60s"], ["SERVER_SHUTDOWN_TIMEOUT", "关闭超时", false, "15s", "15s"],
...
const frameworkVariables = allFrameworkVariables.map((entry) => entry[0] === "SESSION_COOKIE_NAME" ? [...entry.slice(0, 3), "auth", "auth"] : entry);
